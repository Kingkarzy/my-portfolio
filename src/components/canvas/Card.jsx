...
const Card = ({ name, image, description, tags, color }) => {
  return (
    <div className='w-80 min-h-fit lg:h-[600px] flex flex-col justify-between gap-y-5 md:mt-20 rounded-xl text-center backdrop-blur-sm bg-white/10 p-3 cursor-pointer box-content animate-bounce-slow hover:animate-none hover:scale-105 hover:shadow-2xl  '>
